  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          <h1 className="text-4xl font-bold text-mahogany mb-4">Game Over!</h1>
          <p className="text-warmBrown text-lg">Final Standings</p>
        </motion.div>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-mahogany">Global Leaderboard</h3>
